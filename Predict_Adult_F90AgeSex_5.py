...
#Hyper-Parameters
layer1 = 215
dropout1 = .22822287566063298
batch_size = 176
optimizer = optimizers.Adadelta(lr=0.0005)#0.005698420079163188)
...
csvlogger = CSVLogger("HO_output_adultF90AgeSex.csv", separator=",", append = False)
checkpoint = ModelCheckpoint("Adult_F90AgeSex_MLP5.hdf5", monitor='val_loss', verbose=1, save_best_only=True, save_weights_only=False, mode='auto', period=5)
...
valid_auc = roc_auc_score(y_valid, yhat)
yhat = model.predict(x_test)
test_auc = roc_auc_score(y_test, yhat)
print("Valid and Test AUCs: ", valid_auc, test_auc)
...
pyplot.legend()
#pyplot.show()
pyplot.savefig('Training_curve_Adult_F90AgeSex_5.png')
...
columns=("uniqueID", "ADHD", "prob_Adult_F90AgeSex_5")
prediction.to_csv("prob_Adult_F90AgeSex_5.csv", header=columns)
